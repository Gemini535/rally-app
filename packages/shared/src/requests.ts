...
export const VenueSearchQuery = z.object({ sport: SportSlugSchema.optional(), q: z.string().trim().max(100).optional(), lat: z.coerce.number().optional(), lng: z.coerce.number().optional(), radiusMeters: z.coerce.number().positive().max(50_000).optional(), city: z.string().trim().optional(), cursor: CursorSchema });
